...
//                    String[] urlarray2 = urlarray[0].split("/");
//
//                    String idis = urlarray2[urlarray2.length - 1];
//                    System.out.println("facebookids  77 =" + idis);
//
//
//                    // url = "https://www.facebook.com/video/embed?video_id=" + idis;
//                    url = "https://m.facebook.com/MetaforDevelopers/videos/10152795258318553/";
//
//                } catch (Exception e) {
//                    e.printStackTrace();
//                }
...
//        url = "https://www.instagram.com/p/CowgMNkPSeV/?utm_source=ig_web_copy_link";
...
//        binding.browser.getSettings().setUserAgentString(binding.browser.getSettings().getUserAgentString());
        ...
        if (url.contains("facebook") || url.contains("fb.watch")) {
            ...
            binding.browser.getSettings().setUserAgentString("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Safari/537.36");
        }
                                ...
                                view1.evaluateJavascript("javascript:(function() { document.getElementsByTagName('video')[0].play(); })()", value -> {
                                    ...
                                    if (videoModelArrayList != null && videoModelArrayList.size() > 0) {
                                        ...
                                        for (int i = 0; i < videoModelArrayList.size(); i++) {
                                            ...
                                            DownloadFileMain.startDownloading(GetLinkThroughWebView.this, videoModelArrayList.get(i).getUrl(), "threads_" + System.currentTimeMillis(), videoModelArrayList.get(i).getType());
                                        }
            ...
            try {
                ...
                if (!isOnetime) {
                    ...
                    if (myurl.contains("audiomack")) {
                        ...
                        DownloadFileMain.startDownloading(GetLinkThroughWebView.this, html, "threadsnet_" + System.currentTimeMillis(), ".mp4");
