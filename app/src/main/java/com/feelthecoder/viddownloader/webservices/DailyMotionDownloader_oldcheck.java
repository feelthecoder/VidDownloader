...
public class DailyMotionDownloader_oldcheck {
    ...
    public DailyMotionDownloader_oldcheck(Context context, String quality, String videoURL, int downloadManagerID) {
    ...
    private class Data extends AsyncTask<String, String, String> {
                ...
                while ((Line = reader.readLine()) != null) {
                    if (Line.contains("var config")) {
                        ...
                        switch (Quality) {
                            ...
                            case "360p": {
                                if (line2.contains("360")) {
                                    String line3 = line2.substring(line2.indexOf("360"), line2.indexOf("480"));
                                    String line4 = line3.substring(line3.indexOf("video\\/mp4\""), line3.lastIndexOf("}"));
                                    String UrlFinal = line4.substring(line4.indexOf("https"), line4.lastIndexOf("\""));
                                    buffer.append(UrlFinal);
                                } else {
        ...
        protected void onPostExecute(String o) {
            ...
            String nameoffile = simpleDateFormat.format(new Date()) + "video.mp4";
            File newFile = new File(path, nameoffile);


            DownloadFileMain.startDownloading(context, FinalURL, nameoffile, ".mp4");
