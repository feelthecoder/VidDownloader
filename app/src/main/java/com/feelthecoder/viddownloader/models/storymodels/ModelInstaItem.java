...
package com.feelthecoder.viddownloader.models.storymodels;

import androidx.annotation.Keep;

import com.google.gson.annotations.SerializedName;
import com.feelthecoder.viddownloader.models.instawithlogin.UsersInsta;

import java.io.Serializable;
import java.util.ArrayList;

@Keep
public class ModelInstaItem implements Serializable {
    ...
    private ModelVersionOfImage image_versions2;
    ...
    private ArrayList<ModelVersionOfVideo> video_versions;
    ...
    public ModelVersionOfImage getImage_versions2() {
        return image_versions2;
    }

    public void setImage_versions2(ModelVersionOfImage image_versions2) {
    ...
    public ArrayList<ModelVersionOfVideo> getVideo_versions() {
        return video_versions;
    }

    public void setVideo_versions(ArrayList<ModelVersionOfVideo> video_versions) {
