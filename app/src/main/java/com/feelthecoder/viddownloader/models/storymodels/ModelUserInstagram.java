...
@Keep
public class ModelUserInstagram implements Serializable {
    ...
    private ModelProfiledetails modelProfiledetails;
    ...
    public ModelProfiledetails getModelProfiledetails() {
        return modelProfiledetails;
    }

    public void setModelProfiledetails(ModelProfiledetails modelProfiledetails) {
        this.modelProfiledetails = modelProfiledetails;
    }
