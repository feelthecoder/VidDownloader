...
public class TikTokDownloadCloudBypassWebview_method_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            progressDialog = new ProgressDialog(TikTokDownloadCloudBypassWebview_method_5.this);
            ...
            binding.opentiktok.setOnClickListener(view1 -> {
                try {
                    ...
                    iUtils.ShowToast(TikTokDownloadCloudBypassWebview_method_5.this, "Tiktok not Installed");
                }
            });
            ...
            binding.webViewscan.setDownloadListener((url, userAgent, contentDisposition, mimetype, contentLength) -> {
                ...
                DownloadFileMain.startDownloading(TikTokDownloadCloudBypassWebview_method_5.this, url, nametitle, ".mp4");
            ...
            Cloudflare cf = new Cloudflare(TikTokDownloadCloudBypassWebview_method_5.this, "https://tiktokdownload.online/");
            ...
            cf.setCfCallback(new CfCallback() {
                ...
                public void onFail(int code, String msg) {
                    ...
                    binding.webViewscan.loadUrl("https://tiktokdownload.online/");
            ...
            try {
                ...
                handler1.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        view.evaluateJavascript("javascript:document.getElementsByTagName('a')[6].getAttribute('href')", obj -> {
                            ...
                            if (obj != null && obj.contains("http")) {
                                ...
                                if (!isdownloadstarted) {
                                    ...
                                    DownloadFileMain.startDownloading(TikTokDownloadCloudBypassWebview_method_5.this, obj, nametitle, ".mp4");
