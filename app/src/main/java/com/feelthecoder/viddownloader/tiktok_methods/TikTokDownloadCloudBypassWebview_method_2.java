...
public class TikTokDownloadCloudBypassWebview_method_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            progressDialog = new ProgressDialog(TikTokDownloadCloudBypassWebview_method_2.this);
        ...
        binding.opentiktok.setOnClickListener(view1 -> {
            try {
                ...
                iUtils.ShowToast(TikTokDownloadCloudBypassWebview_method_2.this, "Tiktok not Installed");
            }
        });
        ...
        binding.webViewscan.setDownloadListener((url, userAgent, contentDisposition, mimetype, contentLength) -> {
            ...
            DownloadFileMain.startDownloading(TikTokDownloadCloudBypassWebview_method_2.this, url, nametitle, ".mp4");
        ...
        Cloudflare cf = new Cloudflare(TikTokDownloadCloudBypassWebview_method_2.this, "http://tikdd.infusiblecoder.com/");
        ...
        cf.setCfCallback(new CfCallback() {
            ...
            public void onFail(int code, String msg) {
                ...
                binding.webViewscan.loadUrl("http://tikdd.infusiblecoder.com/");
    ...
    private class MyBrowser extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            String jsscript = "javascript:(function() { "
                    ...
                    + "document.getElementById(\"inputboxurl\").value ='" + myvidintenturlis + "';"
            ...
            try {
                ...
                handler1.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        view.evaluateJavascript("javascript:document.getElementsByTagName('a')[0].getAttribute('href')", obj -> {
                            ...
                            if (obj != null && obj.contains("http")) {
                                ...
                                if (!isdownloadstarted) {
                                    DownloadFileMain.startDownloading(TikTokDownloadCloudBypassWebview_method_2.this, obj, "Tiktok_" + System.currentTimeMillis(), ".mp4");
