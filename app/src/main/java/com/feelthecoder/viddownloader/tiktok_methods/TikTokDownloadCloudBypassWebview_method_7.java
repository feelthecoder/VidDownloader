...
public class TikTokDownloadCloudBypassWebview_method_7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            progressDialog = new ProgressDialog(TikTokDownloadCloudBypassWebview_method_7.this);
        ...
        binding.opentiktok.setOnClickListener(view1 -> {
            try {
                ...
                iUtils.ShowToast(TikTokDownloadCloudBypassWebview_method_7.this, "Tiktok not Installed");
            }
        });
        ...
        try {
            Cloudflare cf = new Cloudflare(TikTokDownloadCloudBypassWebview_method_7.this, "http://tikdd.infusiblecoder.com/");
                        ...
                        view.evaluateJavascript("javascript:document.getElementsByTagName('a')[0].getAttribute('href')", obj -> {
                            ...
                            if (obj != null && obj.contains("http")) {
                                ...
                                if (!isdownloadstarted) {
                                    DownloadFileMain.startDownloading(TikTokDownloadCloudBypassWebview_method_7.this, obj, "Tiktok_" + System.currentTimeMillis(), ".mp4");
