            ...
            try {
                ...
                handler1.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        view.evaluateJavascript("javascript:document.getElementsByTagName('a')[8].getAttribute('href')", obj -> {
                            ...
                            if (obj != null && obj.contains("http")) {
                                ...
                                if (!isdownloadstarted) {
                                    DownloadFileMain.startDownloading(TikTokDownloadCloudBypassWebview.this, obj, "Tiktok_" + System.currentTimeMillis(), ".mp4");
